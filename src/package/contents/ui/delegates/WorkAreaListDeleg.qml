...
Item{
    ...
    Text{
        ...
        Behavior on height{
            NumberAnimation{
                duration: 3*storedParameters.animationsStep2;
    ...
    ListView.onRemove: SequentialAnimation {
        ...
        NumberAnimation { target: workList; property: "opacity"; to: 0; duration: 2*storedParameters.animationsStep; easing.type: Easing.InOutQuad }
